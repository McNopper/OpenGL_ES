...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example16_ES/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../Example16_ES/shader/phong.frag.glsl", &fragmentSource);
