...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example03_ES/shader/texture.vert.glsl", &vertexSource);
    glusFileLoadText("../Example03_ES/shader/grey.frag.glsl", &fragmentSource);

    glusProgramBuildFromSource(&g_program, (const GLchar**) &vertexSource.text, (const GLchar**) &fragmentSource.text);
