...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example11_ES/shader/glass.vert.glsl", &vertexSource);
    glusFileLoadText("../Example11_ES/shader/glass.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("../Example11_ES/shader/background.vert.glsl", &vertexSource);
    glusFileLoadText("../Example11_ES/shader/background.frag.glsl", &fragmentSource);
