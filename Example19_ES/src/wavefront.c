/**
 * OpenGL ES 3.0 - Example 19 - Rendering of the wavefront object
 *
...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("../Example19_ES/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../Example19_ES/shader/phong.frag.glsl", &fragmentSource);
