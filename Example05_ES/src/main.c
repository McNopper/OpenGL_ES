...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example05_ES/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("../Example05_ES/shader/phong.frag.glsl", &fragmentSource);
