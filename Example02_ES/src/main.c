...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example02_ES/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText("../Example02_ES/shader/red.frag.glsl", &fragmentSource);
