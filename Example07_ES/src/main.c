...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("../Example07_ES/shader/normmap.vert.glsl", &vertexSource);
    glusFileLoadText("../Example07_ES/shader/normmap.frag.glsl", &fragmentSource);
