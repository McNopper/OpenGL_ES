...
GLUSboolean init(GLUSvoid)
{
    ...
    glusLoadTextFile("../Example20_ES/shader/checker.vert.glsl", &vertexSource);
    glusLoadTextFile("../Example20_ES/shader/checker.frag.glsl", &fragmentSource);
