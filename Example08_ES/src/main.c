...
GLUSboolean init(GLUSvoid)
{
    ...
    glusLoadTextFile("../Example08_ES/shader/cubemap.vert.glsl", &vertexSource);
    glusLoadTextFile("../Example08_ES/shader/cubemap.frag.glsl", &fragmentSource);
