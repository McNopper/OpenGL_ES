...
GLUSboolean init(GLUSvoid)
{
    ...
    glusLoadTextFile("../Example04_ES/shader/basic.vert.glsl", &vertexSource);
    glusLoadTextFile("../Example04_ES/shader/color.frag.glsl", &fragmentSource);
